...
*/
public class CarolPubSubEventFormatter implements IEventFormatter {   
    ...
    public byte[] formatEventBatch(List<SinkRecord> batch) throws IOException {        
        ...
        for(SinkRecord record : batch) {
            ...
            System.out.println("AQUI SUA MENSAGEM: ");
            System.out.println(mystring);
            System.out.println("AQUI SUA MENSAGEM FORMATADA: ");
            System.out.println(mystring.replaceAll("\\{\\{","\\{"));

            events.add(mystring.replaceAll("\\{\\{","\\{"));
